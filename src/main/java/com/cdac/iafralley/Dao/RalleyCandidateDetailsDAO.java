...
public interface RalleyCandidateDetailsDAO extends JpaRepository<RalleyCandidateDetails, Long> {
	...
	@Query("select r from RalleyCandidateDetails r where r.emailid= :email and r.rally_id= :rallyid and r.ralleyregistrationNo=:rallyregno and r.isAdminCardGenrated=false and r.isAllocated=false")
	public RalleyCandidateDetails findByEmailidAndRallyidAdmitCard(@Param("email")String email,@Param("rallyid")String rallyid,@Param("rallyregno")String ralleyregno);
